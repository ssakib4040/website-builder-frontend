...
function createDefaultCollections(): Collection[] {
  // Blog Posts field ids
  const bpTitle = genId(), bpSlug = genId(), bpStatus = genId(),
    bpPublishedAt = genId(), bpAuthor = genId(), bpCategory = genId(),
    bpReadTime = genId(), bpFeatured = genId();

  // Products field ids
  const prName = genId(), prPrice = genId(), prSku = genId(),
    prCategory = genId(), prInStock = genId(), prDescription = genId(),
    prCreatedAt = genId();

  // Team Members field ids
  const tmName = genId(), tmEmail = genId(), tmRole = genId(),
    tmDepartment = genId(), tmStartDate = genId(), tmActive = genId();

  // Customers field ids
  const cuName = genId(), cuEmail = genId(), cuPlan = genId(),
    cuMrr = genId(), cuJoinedAt = genId(), cuActive = genId();

  // Testimonials field ids
  const teName = genId(), teRole = genId(), teCompany = genId(),
    teQuote = genId(), teRating = genId(), teFeatured = genId();
  ...
  return [
    {
      ...
      icon: "FileText",
      fields: [
        { id: bpTitle, name: "title", type: "text", required: true },
        { id: bpSlug, name: "slug", type: "text", required: true },
        { id: bpStatus, name: "status", type: "select", required: true, options: ["draft", "published", "archived"] },
        { id: bpPublishedAt, name: "publishedAt", type: "date", required: false },
        { id: bpAuthor, name: "author", type: "text", required: true },
        { id: bpCategory, name: "category", type: "select", required: false, options: ["Engineering", "Design", "Product", "Company"] },
        { id: bpReadTime, name: "readTime", type: "number", required: false },
        { id: bpFeatured, name: "featured", type: "boolean", required: false },
      ],
      records: [
        { [bpTitle]: "Getting Started with WebCraft", [bpSlug]: "getting-started-with-webcraft", [bpStatus]: "published", [bpPublishedAt]: "2026-03-01", [bpAuthor]: "Sarah Chen", [bpCategory]: "Engineering", [bpReadTime]: 5, [bpFeatured]: true },
        { [bpTitle]: "Designing for Conversion", [bpSlug]: "designing-for-conversion", [bpStatus]: "published", [bpPublishedAt]: "2026-03-08", [bpAuthor]: "Marcus Reed", [bpCategory]: "Design", [bpReadTime]: 7, [bpFeatured]: false },
        { [bpTitle]: "Data Collections Deep Dive", [bpSlug]: "data-collections-deep-dive", [bpStatus]: "published", [bpPublishedAt]: "2026-03-15", [bpAuthor]: "Sarah Chen", [bpCategory]: "Engineering", [bpReadTime]: 9, [bpFeatured]: true },
        { [bpTitle]: "What's New in March 2026", [bpSlug]: "whats-new-march-2026", [bpStatus]: "published", [bpPublishedAt]: "2026-03-20", [bpAuthor]: "Tom Wright", [bpCategory]: "Company", [bpReadTime]: 4, [bpFeatured]: false },
        { [bpTitle]: "Building Your First E-commerce Site", [bpSlug]: "first-ecommerce-site", [bpStatus]: "draft", [bpPublishedAt]: "", [bpAuthor]: "Marcus Reed", [bpCategory]: "Product", [bpReadTime]: 11, [bpFeatured]: false },
        { [bpTitle]: "SEO Best Practices for No-Code Builders", [bpSlug]: "seo-best-practices", [bpStatus]: "draft", [bpPublishedAt]: "", [bpAuthor]: "Sarah Chen", [bpCategory]: "Engineering", [bpReadTime]: 8, [bpFeatured]: false },
        { [bpTitle]: "Year in Review 2025", [bpSlug]: "year-in-review-2025", [bpStatus]: "archived", [bpPublishedAt]: "2025-12-31", [bpAuthor]: "Tom Wright", [bpCategory]: "Company", [bpReadTime]: 6, [bpFeatured]: false },
      ],
    },
    {
      id: genId(),
      ...
      icon: "ShoppingBag",
      fields: [
        { id: prName, name: "name", type: "text", required: true },
        { id: prPrice, name: "price", type: "number", required: true },
        { id: prSku, name: "sku", type: "text", required: true },
        { id: prCategory, name: "category", type: "select", required: false, options: ["Templates", "Plugins", "Themes", "Services"] },
        { id: prInStock, name: "inStock", type: "boolean", required: false },
        { id: prDescription, name: "description", type: "text", required: false },
        { id: prCreatedAt, name: "createdAt", type: "date", required: false },
      ],
      records: [
        { [prName]: "Starter Template Pack", [prPrice]: 29, [prSku]: "TPL-001", [prCategory]: "Templates", [prInStock]: true, [prDescription]: "10 ready-to-use page templates", [prCreatedAt]: "2026-01-10" },
        { [prName]: "Pro Theme Bundle", [prPrice]: 49, [prSku]: "THM-002", [prCategory]: "Themes", [prInStock]: true, [prDescription]: "5 premium themes with dark mode", [prCreatedAt]: "2026-01-15" },
        { [prName]: "E-commerce Plugin", [prPrice]: 79, [prSku]: "PLG-003", [prCategory]: "Plugins", [prInStock]: true, [prDescription]: "Full cart and checkout flow", [prCreatedAt]: "2026-02-01" },
        { [prName]: "Blog Template Set", [prPrice]: 19, [prSku]: "TPL-004", [prCategory]: "Templates", [prInStock]: true, [prDescription]: "6 modern blog layouts", [prCreatedAt]: "2026-02-10" },
        { [prName]: "Analytics Dashboard Plugin", [prPrice]: 39, [prSku]: "PLG-005", [prCategory]: "Plugins", [prInStock]: false, [prDescription]: "Embed charts and stats blocks", [prCreatedAt]: "2026-02-20" },
        { [prName]: "Launch Accelerator Service", [prPrice]: 299, [prSku]: "SVC-006", [prCategory]: "Services", [prInStock]: true, [prDescription]: "Done-with-you setup call and review", [prCreatedAt]: "2026-03-01" },
        { [prName]: "Portfolio Theme", [prPrice]: 24, [prSku]: "THM-007", [prCategory]: "Themes", [prInStock]: true, [prDescription]: "Minimal portfolio for creatives", [prCreatedAt]: "2026-03-05" },
        { [prName]: "Form Builder Plugin", [prPrice]: 29, [prSku]: "PLG-008", [prCategory]: "Plugins", [prInStock]: true, [prDescription]: "Multi-step forms with validation", [prCreatedAt]: "2026-03-12" },
      ],
    },
    {
      id: genId(),
      ...
      icon: "Users",
      fields: [
        { id: tmName, name: "name", type: "text", required: true },
        { id: tmEmail, name: "email", type: "email", required: true },
        { id: tmRole, name: "role", type: "select", required: true, options: ["Engineer", "Designer", "Product Manager", "Marketing", "Support"] },
        { id: tmDepartment, name: "department", type: "select", required: false, options: ["Engineering", "Design", "Product", "Growth"] },
        { id: tmStartDate, name: "startDate", type: "date", required: false },
        { id: tmActive, name: "active", type: "boolean", required: false },
      ],
      records: [
        { [tmName]: "Sarah Chen", [tmEmail]: "sarah@webcraft.io", [tmRole]: "Engineer", [tmDepartment]: "Engineering", [tmStartDate]: "2024-03-01", [tmActive]: true },
        { [tmName]: "Marcus Reed", [tmEmail]: "marcus@webcraft.io", [tmRole]: "Designer", [tmDepartment]: "Design", [tmStartDate]: "2024-05-15", [tmActive]: true },
        { [tmName]: "Tom Wright", [tmEmail]: "tom@webcraft.io", [tmRole]: "Product Manager", [tmDepartment]: "Product", [tmStartDate]: "2024-01-20", [tmActive]: true },
        { [tmName]: "Priya Nair", [tmEmail]: "priya@webcraft.io", [tmRole]: "Engineer", [tmDepartment]: "Engineering", [tmStartDate]: "2024-07-10", [tmActive]: true },
        { [tmName]: "James Liu", [tmEmail]: "james@webcraft.io", [tmRole]: "Marketing", [tmDepartment]: "Growth", [tmStartDate]: "2024-09-01", [tmActive]: true },
        { [tmName]: "Elena Rossi", [tmEmail]: "elena@webcraft.io", [tmRole]: "Support", [tmDepartment]: "Growth", [tmStartDate]: "2025-01-15", [tmActive]: true },
        { [tmName]: "David Park", [tmEmail]: "david@webcraft.io", [tmRole]: "Engineer", [tmDepartment]: "Engineering", [tmStartDate]: "2025-04-01", [tmActive]: false },
      ],
    },
    {
      id: genId(),
      ...
      icon: "Building2",
      fields: [
        { id: cuName, name: "name", type: "text", required: true },
        { id: cuEmail, name: "email", type: "email", required: true },
        { id: cuPlan, name: "plan", type: "select", required: true, options: ["hobby", "pro", "team"] },
        { id: cuMrr, name: "mrr", type: "number", required: false },
        { id: cuJoinedAt, name: "joinedAt", type: "date", required: false },
        { id: cuActive, name: "active", type: "boolean", required: false },
      ],
      records: [
        { [cuName]: "Acme Corp", [cuEmail]: "hello@acmecorp.com", [cuPlan]: "team", [cuMrr]: 49, [cuJoinedAt]: "2025-06-01", [cuActive]: true },
        { [cuName]: "Bloom Studio", [cuEmail]: "hi@bloomstudio.co", [cuPlan]: "pro", [cuMrr]: 19, [cuJoinedAt]: "2025-08-14", [cuActive]: true },
        { [cuName]: "Nova Labs", [cuEmail]: "team@novalabs.io", [cuPlan]: "team", [cuMrr]: 49, [cuJoinedAt]: "2025-09-03", [cuActive]: true },
        { [cuName]: "Sam Rivera", [cuEmail]: "sam@samrivera.me", [cuPlan]: "hobby", [cuMrr]: 0, [cuJoinedAt]: "2025-10-22", [cuActive]: true },
        { [cuName]: "Pixel & Co", [cuEmail]: "hello@pixelco.io", [cuPlan]: "pro", [cuMrr]: 19, [cuJoinedAt]: "2025-11-08", [cuActive]: true },
        { [cuName]: "Stack Ventures", [cuEmail]: "ops@stackventures.com", [cuPlan]: "team", [cuMrr]: 49, [cuJoinedAt]: "2025-12-01", [cuActive]: false },
        { [cuName]: "Mia Clarke", [cuEmail]: "mia@miaclarke.co", [cuPlan]: "pro", [cuMrr]: 19, [cuJoinedAt]: "2026-01-17", [cuActive]: true },
        { [cuName]: "Tundra Games", [cuEmail]: "dev@tundragames.gg", [cuPlan]: "hobby", [cuMrr]: 0, [cuJoinedAt]: "2026-02-05", [cuActive]: true },
        { [cuName]: "Fern Digital", [cuEmail]: "studio@ferndigital.io", [cuPlan]: "pro", [cuMrr]: 19, [cuJoinedAt]: "2026-03-10", [cuActive]: true },
      ],
    },
    {
      id: genId(),
      ...
      icon: "Star",
      fields: [
        { id: teName, name: "name", type: "text", required: true },
        { id: teRole, name: "role", type: "text", required: false },
        { id: teCompany, name: "company", type: "text", required: false },
        { id: teQuote, name: "quote", type: "text", required: true },
        { id: teRating, name: "rating", type: "number", required: false },
        { id: teFeatured, name: "featured", type: "boolean", required: false },
      ],
      records: [
        { [teName]: "Alex Morgan", [teRole]: "Founder", [teCompany]: "Bloom Studio", [teQuote]: "WebCraft cut our launch time in half. The data collections feature alone is worth it.", [teRating]: 5, [teFeatured]: true },
        { [teName]: "Jordan Lee", [teRole]: "Product Lead", [teCompany]: "Nova Labs", [teQuote]: "I migrated from Webflow and couldn't be happier. The API builder is insanely powerful.", [teRating]: 5, [teFeatured]: true },
        { [teName]: "Casey Kim", [teRole]: "Freelancer", [teCompany]: "", [teQuote]: "Finally a no-code tool that doesn't limit you as you grow. My clients love the results.", [teRating]: 5, [teFeatured]: false },
        { [teName]: "Taylor Brooks", [teRole]: "CEO", [teCompany]: "Acme Corp", [teQuote]: "Deployed our entire marketing site in a weekend. The team collaboration features are smooth.", [teRating]: 4, [teFeatured]: true },
        { [teName]: "Morgan Davis", [teRole]: "Designer", [teCompany]: "Pixel & Co", [teQuote]: "The design controls are surprisingly deep. Way more than I expected from a no-code builder.", [teRating]: 4, [teFeatured]: false },
        { [teName]: "Riley Shaw", [teRole]: "Engineer", [teCompany]: "Stack Ventures", [teQuote]: "It doesn't try to replace code — it just handles the parts that shouldn't need it.", [teRating]: 5, [teFeatured]: false },
      ],
    },
  ];
}
...
// ── Default endpoints ──────────────────────────────────
function createDefaultEndpoints(): ApiEndpoint[] {
  // Grab collection ids from defaultCollections by name
  const col = (name: string) =>
    defaultCollections.find((c) => c.name === name)?.id ?? null;

  return [
    // ── Blog Posts ──────────────────────────────────
    { id: genId(), name: "List Blog Posts",    method: "GET",    path: "/api/blog-posts",       collectionId: col("Blog Posts"),   description: "Returns all blog posts, ordered by publishedAt desc.",        enabled: true  },
    { id: genId(), name: "Get Blog Post",      method: "GET",    path: "/api/blog-posts/:id",   collectionId: col("Blog Posts"),   description: "Fetch a single blog post by its ID.",                         enabled: true  },
    { id: genId(), name: "Create Blog Post",   method: "POST",   path: "/api/blog-posts",       collectionId: col("Blog Posts"),   description: "Create a new blog post. Body must include title and author.", enabled: true  },
    { id: genId(), name: "Update Blog Post",   method: "PUT",    path: "/api/blog-posts/:id",   collectionId: col("Blog Posts"),   description: "Update fields on an existing blog post.",                     enabled: true  },
    { id: genId(), name: "Delete Blog Post",   method: "DELETE", path: "/api/blog-posts/:id",   collectionId: col("Blog Posts"),   description: "Permanently delete a blog post.",                             enabled: false },

    // ── Products ────────────────────────────────────
    { id: genId(), name: "List Products",      method: "GET",    path: "/api/products",         collectionId: col("Products"),     description: "Returns all products. Supports ?category= filter.",           enabled: true  },
    { id: genId(), name: "Get Product",        method: "GET",    path: "/api/products/:id",     collectionId: col("Products"),     description: "Fetch a single product by ID.",                               enabled: true  },
    { id: genId(), name: "Create Product",     method: "POST",   path: "/api/products",         collectionId: col("Products"),     description: "Add a new product to the catalog.",                           enabled: true  },
    { id: genId(), name: "Update Product",     method: "PUT",    path: "/api/products/:id",     collectionId: col("Products"),     description: "Update product fields (price, stock, description…).",         enabled: true  },
    { id: genId(), name: "Delete Product",     method: "DELETE", path: "/api/products/:id",     collectionId: col("Products"),     description: "Remove a product from the catalog.",                          enabled: false },

    // ── Team Members ────────────────────────────────
    { id: genId(), name: "List Team Members",  method: "GET",    path: "/api/team",             collectionId: col("Team Members"), description: "Returns all team members. Filter by ?active=true.",          enabled: true  },
    { id: genId(), name: "Get Team Member",    method: "GET",    path: "/api/team/:id",         collectionId: col("Team Members"), description: "Fetch a single team member record.",                          enabled: true  },
    { id: genId(), name: "Invite Team Member", method: "POST",   path: "/api/team",             collectionId: col("Team Members"), description: "Add a new team member and trigger invite email.",             enabled: true  },
    { id: genId(), name: "Update Team Member", method: "PUT",    path: "/api/team/:id",         collectionId: col("Team Members"), description: "Update role, department, or active status.",                  enabled: true  },

    // ── Customers ───────────────────────────────────
    { id: genId(), name: "List Customers",     method: "GET",    path: "/api/customers",        collectionId: col("Customers"),    description: "Returns all customers. Supports ?plan= and ?active= filters.", enabled: true  },
    { id: genId(), name: "Get Customer",       method: "GET",    path: "/api/customers/:id",    collectionId: col("Customers"),    description: "Fetch full profile for a single customer.",                   enabled: true  },
    { id: genId(), name: "Create Customer",    method: "POST",   path: "/api/customers",        collectionId: col("Customers"),    description: "Register a new customer record.",                             enabled: true  },
    { id: genId(), name: "Update Customer",    method: "PUT",    path: "/api/customers/:id",    collectionId: col("Customers"),    description: "Update plan, email or active status.",                        enabled: true  },
    { id: genId(), name: "Delete Customer",    method: "DELETE", path: "/api/customers/:id",    collectionId: col("Customers"),    description: "Hard-delete a customer record.",                              enabled: false },

    // ── Testimonials ────────────────────────────────
    { id: genId(), name: "List Testimonials",  method: "GET",    path: "/api/testimonials",     collectionId: col("Testimonials"), description: "Returns all testimonials. Use ?featured=true for homepage.",  enabled: true  },
    { id: genId(), name: "Create Testimonial", method: "POST",   path: "/api/testimonials",     collectionId: col("Testimonials"), description: "Submit a new testimonial.",                                   enabled: true  },
    { id: genId(), name: "Delete Testimonial", method: "DELETE", path: "/api/testimonials/:id", collectionId: col("Testimonials"), description: "Remove a testimonial.",                                       enabled: false },

    // ── Auth ────────────────────────────────────────
    { id: genId(), name: "Sign Up",            method: "POST",   path: "/api/auth/signup",      collectionId: null,                description: "Create a new user account. Returns JWT + user object.",       enabled: true  },
    { id: genId(), name: "Sign In",            method: "POST",   path: "/api/auth/signin",      collectionId: null,                description: "Authenticate with email + password. Returns JWT.",            enabled: true  },
    { id: genId(), name: "Sign Out",           method: "POST",   path: "/api/auth/signout",     collectionId: null,                description: "Invalidate the current session token.",                       enabled: true  },
    { id: genId(), name: "Get Current User",   method: "GET",    path: "/api/auth/me",          collectionId: null,                description: "Returns the authenticated user profile from the JWT.",        enabled: true  },
    { id: genId(), name: "Reset Password",     method: "POST",   path: "/api/auth/reset",       collectionId: null,                description: "Send a password reset email to the provided address.",        enabled: true  },

    // ── Misc / Utility ──────────────────────────────
    { id: genId(), name: "Send Contact Form",  method: "POST",   path: "/api/contact",          collectionId: null,                description: "Accepts contact form submissions and sends notification email.", enabled: true },
    { id: genId(), name: "Subscribe Newsletter", method: "POST", path: "/api/newsletter/subscribe", collectionId: null,            description: "Add an email to the newsletter list.",                        enabled: true  },
    { id: genId(), name: "Unsubscribe Newsletter", method: "DELETE", path: "/api/newsletter/unsubscribe", collectionId: null,      description: "Remove an email from the newsletter list.",                   enabled: true  },
    { id: genId(), name: "Health Check",       method: "GET",    path: "/api/health",           collectionId: null,                description: "Returns 200 OK with server status and uptime.",               enabled: true  },
    { id: genId(), name: "Upload Asset",       method: "POST",   path: "/api/media/upload",     collectionId: null,                description: "Upload an image or file. Returns CDN URL.",                   enabled: true  },
  ];
}
